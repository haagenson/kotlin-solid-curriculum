...
class OSPrinterTest {
    ...
    @Autowired
    private lateinit var osPrinter: OSPrinter;
    ...
    fun logsAnOperatingSystemAppropriateMessageForWindows(osName: String, expectedMessage: String, output: CapturedOutput) {
